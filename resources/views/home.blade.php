                ...
                @foreach($products as $product)
                    ...
                    <div class="card bs-card" style="width: 18rem;">
                        <div class="product-img">
                            <img src="{{asset('uploads/' . unserialize($product->images)[1])}}" class="card-img-top image" alt="watch image">
                        </div>
                        ...
                        <div class="card-footer bs-card-footer">
                            <div class="d-flex justify-content-between">
                                ...
                                <a href="#" class="btn btn-primary btn-sm bs-btn btn-cart"><i class="fas fa-cart-plus"></i></a>
                            </div>
                        </div>
                    </div>
                    @endforeach
